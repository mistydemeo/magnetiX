...
@interface MXImageView : NSImageView
{
	IBOutlet id controller;
	IBOutlet id imageContextMenu;
...
@property (assign) BOOL isResizeDrag;
@property (assign) float addedPictureSize;
@property (assign) NSSize originalSize;
@property (retain) NSArray *draggedImages;
