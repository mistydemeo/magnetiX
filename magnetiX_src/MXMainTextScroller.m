...
#import "MXMainTextScroller.h"
#import "MagneticController.h"

@implementation MXMainTextScroller


+ (BOOL)isCompatibleWithOverlayScrollers
{
	return self == [MXMainTextScroller class];
}
...
{
	return [(MagneticController *)[[self window] delegate] currentTemplate][@"colorBackground"];
}

- (NSColor *)outlineColor
{
	return [(MagneticController *)[[self window] delegate] currentTemplate][@"colorTextGame"];
}

- (NSColor *)knobColor
{
	return [(MagneticController *)[[self window] delegate] currentTemplate][@"colorTextUser"];
}
