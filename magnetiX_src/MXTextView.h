...
{	
	NSInteger lastMouseDownStatusGlyph;
	NSInteger lastTopPositionGlyph;
	BOOL isMouseDownStatus;
	
	IBOutlet MagneticController *controller;
}
...
@property (assign) BOOL isTypingAllowed;
@property (assign) int gradientHeight;
@property (assign) NSInteger testTempGlyph;
@property (assign) NSInteger testTempLocation;
