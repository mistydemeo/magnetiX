...
{
	IBOutlet NSPopUpButton *templatesPopupButton;
	IBOutlet NSTextField *templateNameTextField;
	IBOutlet id maxWidthSlider;
	IBOutlet id spacingView;
	IBOutlet id spacingButton;
	IBOutlet id gameWindowBox;
	IBOutlet NSPopover *spacingPopover;
	IBOutlet id spacingPopoverController;
	IBOutlet NSPopover *helpPopover;
	IBOutlet id helpPopoverController;
	IBOutlet id charLabel;
	IBOutlet id lineLabel;
	IBOutlet id charSlider;
	IBOutlet id lineSlider;
	IBOutlet NSArrayController *arrayController;
	IBOutlet id tabView;
	IBOutlet id toolbar;
	IBOutlet id helpText;
}
...
@property (assign) BOOL canRemove;
