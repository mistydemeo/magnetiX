...
#import "MXFSSaveBarImageView.h"

@implementation MXFSSaveBarImageView


- (void)mouseDown:(NSEvent *)theEvent
{
	if ([theEvent clickCount] == 2) {
		[[NSNotificationCenter defaultCenter] postNotificationName:@"saveBarImageDoubleClicked" object:nil];
	}
