...
#import "MXGameSelectWindow.h"
#import "GameSelectController.h"

@implementation MXGameSelectWindow
...
- (void)keyDown:(NSEvent *)theEvent
{
	...
	if ([characters length] == 1) {
		...
		if (character == NSLeftArrowFunctionKey || character == NSRightArrowFunctionKey || character == NSUpArrowFunctionKey || character == NSDownArrowFunctionKey || character == ' ') {
			[(GameSelectController *)[self delegate] changeGameSelectionWith:character];
			return;
		}
	}
