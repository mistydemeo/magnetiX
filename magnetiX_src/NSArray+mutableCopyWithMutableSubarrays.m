...
@implementation NSArray (mutableCopyWithMutableSubarrays)


- (NSMutableArray *)mutableCopyWithMutableSubarrays
{
    NSMutableArray *returnArray = [NSMutableArray array];
    
    for (id object in self) {
        
        if ([object respondsToSelector:@selector(mutableCopyWithMutableSubarrays)]) {
            id copy = [object mutableCopyWithMutableSubarrays];
			[returnArray addObject:copy];
			[copy release];
		} else {
